	...
	public function add() {
		...
		if ($product_info) {
			...
			/*END OVICKO MULTISELLER*/
				...
				$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $this->request->post['product_id'].'&seller_id=' . $seller_id), $product_info['name'], $this->url->link('checkout/cart'));
			/*END OVICKO MULTISELLER*/
