	...
	public function addAttribute($data) {
		...
		return $attribute_id;
            ...
            /*START OVICKO MULTISELLER*/
				public function approveData($attribute_id) {
		$option_info = $this->getattribute($attribute_id);
		if ($option_info) {
			$this->db->query("UPDATE `" . DB_PREFIX . "attribute` SET approve = '1' WHERE attribute_id = '" . (int)$attribute_id . "'");
		}		
	}
	public function getSellers() {		$sellers_data = array();
