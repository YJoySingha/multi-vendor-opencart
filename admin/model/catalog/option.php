	...
	public function addOption($data) {
		...
		return $option_id;
            ...
            /*START OVICKO MULTISELLER*/
				public function approveData($option_id) {
		$option_info = $this->getOption($option_id);
		if ($option_info) {
			$this->db->query("UPDATE `" . DB_PREFIX . "option` SET approve = '1' WHERE option_id = '" . (int)$option_id . "'");
		}		
	}
