...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		$data['approve'] = $this->url->link('catalog/category/approve', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		foreach ($results as $result) {
			...
			//var_dump($sellers[$result['seller_id']]);			
			/*END OVICKO MULTISELLER*/
		...
		if (isset($this->request->get['category_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            ...
            /*START OVICKO MULTISELLER*/
				...
				if (isset($this->request->post['approve'])) {
					...
					$data['approve'] = $category_info['approve'];
				} else {
					$data['approve'] = '';
				}
			/*END OVICKO MULTISELLER*/
			...
			elseif (isset($this->request->post['selected'])) {			
				...
				foreach ($this->request->post['selected'] as $category_id) {				
					$category_info = $this->model_catalog_category->getCategory($category_id);
						if ($category_info && !$category_info['approve']) {	
							$this->model_catalog_category->approve($category_id);
							$approved++;
						}		
				} 						
				...
				$this->response->redirect($this->url->link('catalog/category', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
			}				
			$this->getList();	
		}
		/*END OVICKO MULTISELLER*/
