...
class ControllerCommonFileManager extends Controller {
	public function index() {
		...
		foreach ($images as $image) {
			...
			if (is_dir($image)) {
				...
				$data['images'][] = array(
					...
					'href'  => $this->url->link('common/filemanager',  '&directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE .$foldername.'/'))) . $url, 'SSL')
				);
		...
		$data['parent'] = $this->url->link('common/filemanager',  $url, 'SSL');
		// Refresh
		$url = '';
		if (isset($this->request->get['directory'])) {
		...
		$data['refresh'] = $this->url->link('common/filemanager',  $url, 'SSL');
		$url = '';
		if (isset($this->request->get['directory'])) {
		...
		$pagination->limit = 16;
		$pagination->url = $this->url->link('common/filemanager',  $url . '&page={page}', 'SSL');
