...
class ControllerSellerPay extends Controller {
	...
	public function callback() {
		...
		if($seller_id>0) {
			...
			/**
			* Add option to select activated payment gateways
			* Select if test or live
			* Use the checkout mode of selecting payment gateways
			* Create a checkout page for membership upgrade/payment
			*
			*/
