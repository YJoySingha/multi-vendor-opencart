<script type="text/javascript" src="<?php echo $adminurl;?>view/javascript/jquery/jquery-2.1.1.min.js"></script>
<script type="text/javascript" src="<?php echo $adminurl;?>view/javascript/bootstrap/js/bootstrap.min.js"></script>
<link href="<?php echo $adminurl;?>view/javascript/bootstrap/css/bootstrap.css" rel="stylesheet" />
<link href="<?php echo $adminurl;?>view/javascript/font-awesome/css/font-awesome.min.css" type="text/css" rel="stylesheet" />
<link type="text/css" href="<?php echo $adminurl;?>view/stylesheet/stylesheet.css" rel="stylesheet" media="screen" />
<div class="modal-dialog modal-lg" id="modal-image">
    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-5"><a href="<?php echo $parent; ?>" data-toggle="tooltip" title="<?php echo $button_parent; ?>" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
          ...
          <button style="display:none" type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" id="button-delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>
        </div>
        <div class="col-sm-7">
...
$('#button-search').on('click', function() {
	var url = 'index.php?route=seller/filemanager';
	var filter_name = $('input[name=\'search\']').val();
	if (filter_name) {
		url += '&filter_name=' + encodeURIComponent(filter_name);
	}		
