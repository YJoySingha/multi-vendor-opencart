...
class ControllerInstallStep2 extends Controller {
	...
	public function index() {
		...
		// seller configs
		if (!is_file(DIR_OPENCART . 'seller/config.php')) {
			$data['error_seller_config'] = $this->language->get('error_missing');
		} else {
			$data['error_seller_config_seller'] = '';
		}
		
		if (!is_writable(DIR_OPENCART . 'seller/config.php')) {
			$data['error_seller_config'] = $this->language->get('error_unwritable');
		} else {
			$data['error_seller_config'] = '';
		}
		...
		$data['seller_config'] = DIR_OPENCART . 'seller/config.php';
